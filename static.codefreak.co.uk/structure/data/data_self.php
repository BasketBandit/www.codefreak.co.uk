...
if ($size <= 0) {
	...
	$write0 = fopen("/var/www/static.codefreak.co.uk/userdata/" .$username ."/" .$username ."_steamSummary.json", "w") or die("Update failed, please contact developer! 1");
	$write1 = fopen("/var/www/static.codefreak.co.uk/userdata/" .$username ."/" .$username ."_steamBadges.json", "w") or die("Update failed, please contact developer! 2");
	$write2 = fopen("/var/www/static.codefreak.co.uk/userdata/" .$username ."/" .$username ."_steamBans.json", "w") or die("Update failed, please contact developer! 3");
	$write3 = fopen("/var/www/static.codefreak.co.uk/userdata/" .$username ."/" .$username ."_steamGamesOwned.json", "w") or die("Update failed, please contact developer! 4");
	
	$write4 = fopen("/var/www/static.codefreak.co.uk/userdata/" .$username ."/" .$username ."_twitch.json", "w") or die("Update failed, please contact developer! 5");
