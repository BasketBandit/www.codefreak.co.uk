...
$searchUser = hash('sha256',$searchUser);
	...
	$file0 = "/var/www/static.codefreak.co.uk/userdata/" .$searchUser ."/" .$searchUser ."_steamSummary.json";
	$file1 = "/var/www/static.codefreak.co.uk/userdata/" .$searchUser ."/" .$searchUser ."_steamBadges.json";
	$file2 = "/var/www/static.codefreak.co.uk/userdata/" .$searchUser ."/" .$searchUser ."_steamBans.json";
	$file3 = "/var/www/static.codefreak.co.uk/userdata/" .$searchUser ."/" .$searchUser ."_steamGamesOwned.json";
	
	$file4 = "/var/www/static.codefreak.co.uk/userdata/" .$searchUser ."/" .$searchUser ."_twitch.json";
...
if ($size <= 0) {
    ...
    $grav_url_large = "https://www.gravatar.com/avatar/" .md5(strtolower(trim($SearchData['account_email']))) ."?d=mm&s=" . 130;
